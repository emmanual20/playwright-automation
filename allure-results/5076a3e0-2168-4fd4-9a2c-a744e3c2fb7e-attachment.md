...
```
Error: locator.scrollIntoViewIfNeeded: Error: strict mode violation: locator('//*[@id="largeTableBody"]/tr') resolved to 8 elements:
    1) <tr>…</tr> aka getByRole('row', { name: 'Arun 1 QA Inactive' })
    2) <tr>…</tr> aka getByRole('row', { name: 'Priya 2 Developer Active' })
    3) <tr>…</tr> aka getByRole('row', { name: 'Rahul 3 Player Active' })
    4) <tr>…</tr> aka getByRole('row', { name: 'Neha 4 Admin Inactive' })
    5) <tr>…</tr> aka getByRole('row', { name: 'Pavan 5 QA Active' })
    6) <tr>…</tr> aka getByRole('row', { name: 'Arun 6 Developer Active' })
    7) <tr>…</tr> aka getByRole('row', { name: 'Priya 7 Player Inactive' })
    8) <tr>…</tr> aka getByRole('row', { name: 'Rahul 8 Admin Active' })

Call log:
  - waiting for locator('//*[@id="largeTableBody"]/tr')
